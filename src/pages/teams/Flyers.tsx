...
import { FlyersFinancesType } from "../../types/interfaceTypes";
...
interface IProps {
  flyersFinance?: FlyersFinancesType[];
}

function Flyers() {
  const location = useLocation();
  const { flyersFinance } = location.state as IProps;

  return (
    <>
      {flyersFinance && flyersFinance.length ? (
        <>
          {flyersFinance.map((flyers) => (
            <div key={flyers.id}>
              <div>
                <Navbar />
                <div className="p-5 mb-4 mt-5 bg-light rounded-3">
                  <div className="container-fluid">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text">
                        TODAY'S CAP HIT : {flyers.todayCapHit}
                      </p>
                      <p className="text noMargin">
                        ROSTER SIZE: {flyers.rosterSize}
                      </p>
                      <p className="text noMargin">
                        CONTRACTS: {flyers.contracts}
                      </p>
                      <p className="text noMargin">
                        RESERVE LIST: {flyers.reserveList}
                      </p>
                              ...
                              >
                                <TableCell className="text-left">
                                  {row.name !== "TOTAL" ? (
                                    <Link
                                      to={row.link}
                                      className="playerName text-nowrap"
                                    >
                                      {row.name}
                                    </Link>
                                  ) : (
