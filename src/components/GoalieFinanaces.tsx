...
import { GoalieData } from "../types/interfaceTypes";

type GoalieContractsTableProps = {
  goalieData: GoalieData[]; // Array of ForwardData objects
};

const GoalieContractsTable: React.FC<GoalieContractsTableProps> = ({
  goalieData,
}) => {
  return (
    <div>
...
export default GoalieContractsTable;
